...
export default function Projects() {
  const projectList = [
    {
      ...
      link: "https://github.com/alwayshubham/job-board",
    },
    {
      ...
      link: "https://github.com/alwayshubham/bricksowner",
          },
  ];
  const experienced = [ 
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-300 to-pink-200 p-10">
      <h1 className="text-4xl font-bold text-black text-center mb-8 drop-shadow-[0_0_5px_rgba(255,255,0,0.8)]">My Projects</h1>
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        {projectList.map((project, idx) => (
          <div key={idx} className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="mt-4 flex flex-wrap gap-2 font-gray-600">
            ...
            <a href={project.link} target="_blank" rel="noopener noreferrer" className="mt-4 inline-block text-blue-600 hover:underline">
              View Project 
            </a>
          </div>
        ))}
      </div>
      <h1 className="text-4xl font-bold text-black text-center mb-8 drop-shadow-[0_0_5px_rgba(255,255,0,0.8)]">Experience</h1>
{/* Experience data */}
